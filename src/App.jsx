    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '20px' }}>
      ...
      <div style={{ width: '45%' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="button" onClick={handleAddExperience} style={{ marginBottom: '10px' }}>
            Add Experience
          </button>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{ borderBottom: '2px solid #ccc', paddingBottom: '5px' }}>Personal Information</h3>
          ...
          <h3 style={{ borderBottom: '2px solid #ccc', paddingBottom: '5px' }}>Experience</h3>
          {experience.length >1  ? (
          ...
          <h3 style={{ borderBottom: '2px solid #ccc', paddingBottom: '5px' }}>Skills</h3>
